...
- `in_review`: implementation exists and its required independent review is in
  progress.
...
5. Receive independent review for security boundaries, release workflows,
   dependency-risk acceptance, and stable-release decisions.
...
- completed work lacks dated evidence and an independent reviewer;
